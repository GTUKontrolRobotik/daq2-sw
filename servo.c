...
void servo_init(void)
{
     ...
     pwm_init_output_channel(TIM2, SERVO_CH2, &RCC_APB2ENR, RCC_APB2ENR_IOPAEN, GPIOA, GPIO_TIM2_CH4);

     pwm_init_output_channel(TIM2, SERVO_CH3, &RCC_APB2ENR, RCC_APB2ENR_IOPAEN, GPIOA, GPIO_TIM2_PR1_CH1_ETR);

     pwm_set_pulse_width(TIM2, SERVO_CH1, SERVO_NULL);
     pwm_set_pulse_width(TIM2, SERVO_CH2, SERVO_NULL);
     pwm_set_pulse_width(TIM2, SERVO_CH3, SERVO_NULL);
